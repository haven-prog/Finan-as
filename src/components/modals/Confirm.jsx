  ...
  return (
    <div className="ov-c" onClick={e => e.target === e.currentTarget && onNo()}>
      <div className="sc-box">
        ...
        <div style={{ fontFamily: 'Instrument Serif,serif', fontSize: 20, fontWeight: 700, textAlign: 'center', marginBottom: 6 }}>{title}</div>
        <div style={{ fontSize: 12.5, color: 'var(--sub)', textAlign: 'center', marginBottom: 20, lineHeight: 1.5 }}>{msg}</div>
